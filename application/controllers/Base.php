...
class Base extends CI_Controller {
  ...
  */
	...
	{
		$contatos = $this->contatos_model->ObterTodos();
		$dados['messages'] =$this->contatos_model->Formatar($contatos);
  ...
  */
	public function Editar(){
		...
		$dados['contato'] = $this->contatos_model->obterPorId($id);

		// Carrega a view passando os dados do registro
		$this->load->view('gerenciamento/atualizar',$dados);
  ...
  */
	public function Atualizar(){
		...
		if($validacao){
			...
			// Checa o status da operação gravando a mensagem na seção
			if(!$status){
				$dados['contato'] = $this->contatos_model->obterPorId($contato['id']);
