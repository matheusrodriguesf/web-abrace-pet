    ...
    /*Inicializa o mapa passando os valores de entrada*/
      ...
      function initMap() {
        ...
        if (navigator.geolocation) {
            var latitude = parseFloat("<?php Print($animal['LATITUDE']); ?>");
            var longitude = parseFloat("<?php Print($animal['LONGITUDE']); ?>");
          ...
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            infoWindow.setContent('Localização encontrada.' + latitude + longitude);
            map.setCenter(pos);
